// main.c - Seguidor de linha ESP32-S3 (ESP-IDF 6.0.2)
...
void nimble_uart_init(void);  // vindo de ble_nimble_uart.c
...
// Enfileiramento de bytes (chamar do callback BLE)
...
// Task principal de parsing linha a linha
...

{
    ...
    char line_buf[BT_SERIAL_LINE_BUF_LEN];
...

{
    ...
    ESP_LOGI(TAG, "Calibracao QRE concluida, aguardando comando BLE (0/1).");
